...
label = pd.read_csv('/Users/Mehraveh/Downloads/Species101017_labels_new.csv', sep=',', delimiter=None,header=None)
label = label.drop(0, 1)
label = label.iloc[0]

data = pd.read_csv('/Users/Mehraveh/Downloads/Species101017_clean_new.csv', sep=',', delimiter=None, header=None)
data = data.fillna(0)
...
data=data.drop(data.index[data[0]==8]) # The first three rows in data are removed as they are meant to be unknown for the model
data=data.drop(data.index[data[0]==9]) # The first three rows in data are removed as they are meant to be unknown for the model
X=data
